library angular_dart_demo.test.main_test.generated_static_injector;
...
import 'package:angular/mock/module.dart' as import_16;
import '../web/main.dart' as import_17;
...
final Map<Type, TypeFactory> factories = <Type, TypeFactory>{
  ...
  import_16.LogAttrDirective: (f) => new import_16.LogAttrDirective(f(import_16.Logger)),
  import_16.Probe: (f) => new import_16.Probe(f(import_0.Scope), f(import_1.Injector), f(import_9.Element)),
  import_17.RecipeBookController: (f) => new import_17.RecipeBookController(),
