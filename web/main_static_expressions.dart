library angular_dart_demo.web.main.generated_expressions;
...
final Map<String, FieldGetter> getters = {
  ...
  r"ctrl": (o) => o.ctrl,
  r"recipes": (o) => o.recipes,
  r"recipe": (o) => o.recipe,
  r"selectedRecipe": (o) => o.selectedRecipe,
  r"category": (o) => o.category,
  r"rating": (o) => o.rating,
  r"ingredients": (o) => o.ingredients,
  r"ingredient": (o) => o.ingredient,
  r"directions": (o) => o.directions,
  r"selectRecipe": (o) => o.selectRecipe
};
final Map<String, FieldSetter> setters = {
  ...
  r"ctrl": (o, v) => o.ctrl = v,
  r"recipes": (o, v) => o.recipes = v,
  r"recipe": (o, v) => o.recipe = v,
  r"selectedRecipe": (o, v) => o.selectedRecipe = v,
  r"category": (o, v) => o.category = v,
  r"rating": (o, v) => o.rating = v,
  r"ingredients": (o, v) => o.ingredients = v,
  r"ingredient": (o, v) => o.ingredient = v,
  r"directions": (o, v) => o.directions = v
};
