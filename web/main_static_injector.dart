library angular_dart_demo.web.main.generated_static_injector;
...
final Map<Type, TypeFactory> factories = <Type, TypeFactory>{
  import_0.RecipeBookController: (f) => new import_0.RecipeBookController(),
  ...
  import_1.Interpolate: (f) => new import_1.Interpolate(f(import_4.Parser)),
  ...
  import_1.RootScope: (f) => new import_1.RootScope(f(Object), f(import_4.Parser), f(import_6.FieldGetterFactory), f(import_1.FormatterMap), f(import_1.ExceptionHandler), f(import_1.ScopeDigestTTL), f(import_1.VmTurnZone), f(import_1.ScopeStats), f(import_7.ClosureMap)),
  import_7.DynamicParser: (f) => new import_7.DynamicParser(f(import_8.Lexer), f(import_4.ParserBackend)),
  ...
  import_9.ElementBinderFactory: (f) => new import_9.ElementBinderFactory(f(import_4.Parser), f(import_11.Profiler), f(Expando)),
  ...
  import_12.InputCheckbox: (f) => new import_12.InputCheckbox(f(import_10.Element), f(import_12.NgModel), f(import_1.Scope), f(import_12.NgTrueValue), f(import_12.NgFalseValue)),
  import_12.InputTextLike: (f) => new import_12.InputTextLike(f(import_10.Element), f(import_12.NgModel), f(import_1.Scope)),
  import_12.InputNumberLike: (f) => new import_12.InputNumberLike(f(import_10.Element), f(import_12.NgModel), f(import_1.Scope)),
  import_12.NgBindTypeForDateLike: (f) => new import_12.NgBindTypeForDateLike(f(import_10.Element)),
  import_12.InputDateLike: (f) => new import_12.InputDateLike(f(import_10.Element), f(import_12.NgModel), f(import_1.Scope), f(import_12.NgBindTypeForDateLike)),
  ...
  import_12.ContentEditable: (f) => new import_12.ContentEditable(f(import_10.Element), f(import_12.NgModel), f(import_1.Scope)),
  ...
  import_12.NgRepeat: (f) => new import_12.NgRepeat(f(import_9.ViewPort), f(import_9.BoundViewFactory), f(import_1.Scope), f(import_4.Parser), f(import_1.FormatterMap)),
  ...
  import_13.Filter: (f) => new import_13.Filter(f(import_4.Parser)),
  ...
  import_13.OrderBy: (f) => new import_13.OrderBy(f(import_4.Parser)),
