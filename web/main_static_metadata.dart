library angular_dart_demo.web.main.generated_metadata;
...
final Map<Type, Object> typeAnnotations = {
  import_0.RecipeBookController: const [
  ...
  import_3.NgForm: const [
    const import_1.Decorator(selector: 'form', module: import_3.NgForm.module, visibility: import_1.Directive.CHILDREN_VISIBILITY, map: const {'name': '@name'}),
    const import_1.Decorator(selector: 'fieldset', module: import_3.NgForm.module, visibility: import_1.Directive.CHILDREN_VISIBILITY),
    const import_1.Decorator(selector: '.ng-form', module: import_3.NgForm.module, visibility: import_1.Directive.CHILDREN_VISIBILITY),
    const import_1.Decorator(selector: '[ng-form]', module: import_3.NgForm.module, map: const {'ng-form': '@name'}, visibility: import_1.Directive.CHILDREN_VISIBILITY),
  ],
  ...
  import_5.NgView: const [
    const import_1.Decorator(selector: 'ng-view', module: import_5.NgView.module, visibility: import_1.Directive.CHILDREN_VISIBILITY),
  ],
  import_5.NgBindRoute: const [
    const import_1.Decorator(visibility: import_1.Directive.CHILDREN_VISIBILITY, selector: '[ng-bind-route]', module: import_5.NgBindRoute.module, map: const {'ng-bind-route': '@routeName'}),
  ],
};
